...
namespace SubtitleFinderApp.Scrapers
{
    public class TuSubtituloScraper : SourceScraper, ISourceScraper
    {
        ...
        {
            HtmlAgilityPack.HtmlDocument htmldoc = _web.LoadFromBrowser(_ShowsCatalogUrl);
        ...
        {
            HtmlAgilityPack.HtmlDocument tvShowHtml = _web.LoadFromBrowser(tvShowUrl);
        ...
        protected override void _TabCtrlResults_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_TabCtrlResults.SelectedTab.Controls.Count <= 0)
                controls.Add(base.RenderizeSeasonTab(_SeasonUrl[_TabCtrlResults.SelectedTab.Text], SearchSources.TuSubtitulo));
